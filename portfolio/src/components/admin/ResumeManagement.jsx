  ...
  const handleFileChange = async (e) => {
    ...
    if (file) {
      try {
        ...
        setFilePreview(fileData.fileUrl)
      } catch (error) {
                ...
                >
                  ...
                  {filePreview ? (
                    <div className="space-y-4">
                      ...
                      <div>
                        <p className="text-lg font-medium text-gray-900">{formData.fileName}</p>
                ...
                resumes.map((resume) => (
                  <tr key={resume._id} className="hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50/30 transition-all duration-300 group">
                    ...
                    <td className="px-6 py-5 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-600 group-hover:text-gray-800 transition-colors duration-300">{resume.fileName}</div>
                    </td>
                    <td className="px-6 py-5 whitespace-nowrap">
                      <div className="text-sm font-semibold text-gray-600 group-hover:text-gray-800 transition-colors duration-300">{formatFileSize(resume.fileSize)}</div>
                    </td>
                    <td className="px-6 py-5 whitespace-nowrap">
