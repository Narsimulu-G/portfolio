    ...
    const certificatesData = [
      {
        ...
        issuer: 'NXT WAVE',
        date: 'January 2024',
        image: 'https://res.cloudinary.com/dovmtmu7y/image/upload/v1758257912/badri_ekxgwe.jpg',
      ...
      },
      {
        ...
        issuer: 'FreeCodeCamp',
        date: 'November 2023',
        image: 'https://via.placeholder.com/400x300/4F46E5/FFFFFF?text=React+Certificate',
      ...
      },
      {
        ...
        issuer: 'FreeCodeCamp',
        date: 'October 2023',
        image: 'https://via.placeholder.com/400x300/10B981/FFFFFF?text=JS+Certificate',
  ...
  try {
    const projectsData = [
      ...
      },
      {
        ...
        imageUrl: 'https://via.placeholder.com/600x400/8B5CF6/FFFFFF?text=Portfolio',
